...
<html>
    ...
    <body>
        ...
        <div class="container destaque">
            ...
            <main>
                <form id="contrato" action="FinalizarReserva" method="POST">
                    <fieldset class="consultaEstoque">
                        <table>
                            ...
                            <tr><td id="diaria">Valor Total Reserva: R$</td><td><input readonly="readonly" type="text" name="valor" value="${valor}"></td></tr>
                        </table>
                    </fieldset>
                    ...
                    <fieldset class="cliente">
                        <legend>Confirmar Cliente</legend>
                        <table>
