        ...
        <fieldset>
            ...
            <form id="atualizar" action="AtualizarCliente" method="POST">
                <table>
                    ...
                    <tr><td>Data Cadastro:</td><td><input readonly="readonly" title="Não é possível alterar" name="dtCadastro" value="<fmt:formatDate value="${cliente.dataCadastro}" pattern="dd/MM/yyyy"/>"></td></tr>
                </table>
