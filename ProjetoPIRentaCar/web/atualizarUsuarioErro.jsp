...
<html>
    ...
    <body>
        ...
        <div class="container destaque">
            ...
            <main>
                <fieldset>
                    ...
                    <div class="msgerro"><p>*CPF do cliente não encontrado!</p></div>
                        ...
                        <table class="atualizar">
                            ...
                            <c:choose>
                                        <c:when test="${usuario.ativo== true}">
                                            <tr id="radiol"><td id="radio"><input type="radio" name="ativo" checked/></td><td id="label">Ativo</td> <br>
                                            <td><input type="radio" name="ativo"/></td><td id="label">Inativo</td></tr>
                                        </c:when>
                                        <c:when test="${usuario.ativo== false}">
                                            <input type="radio" name="ativo"/>Ativo
                                            <input type="radio" name="ativo" checked/>Inativo</c:when>
                                        <c:otherwise>
                                            <tr id="radiol"><td id="radio"><input disabled type="radio" name="ativo"/></td><td id="label">Ativo</td></tr>
        ...
        </footer><a href="http://localhost:8080/ProjetoPIRentaCar/AcessoUsuarios">Voltar</a>
    </body>
</html>
